...
@Test
@DisplayName("Test Product by Id - GET /products/")
...
@Test
@DisplayName("Test All Products /products/")
...
@Test
@DisplayName("Test All Products By Price /products/{price}")
...
@Test
@DisplayName("Test All Products By Price /products?name=&price")
...
.get("/products/findByPriceorName")
...
mockMvc.perform(put("/products/{id}",50)
// Validate Status should be 200 OK and JSON response received
